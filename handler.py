...
hud = HUD()
btn_undo = Button(margin/4, margin/4, 2*margin, margin/2, "Undo", 20, GRAY, WHITE, board.undoMove)
btn_clear = Button(margin/4, (9/4)*margin + 20, 2*margin, margin/2, "Clear", 20, BLACK, WHITE, board.cleanBoard)
